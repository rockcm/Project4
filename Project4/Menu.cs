...
//                     validates it.
//                     No changes need to be made to this class to use it in your own program.
//	Course:            CSCI-2210 - Data Structures
//	Author:            Katie Wilson, wilsonkl4@etsu.edu, East Tennessee State University
//	Created:           Friday, July 1, 2022
...
public class Menu
{
    ...
    public void Display()
    {
        ...
        Console.ForegroundColor = ConsoleColor.Cyan; //Switch back to blue text for the remainding text
